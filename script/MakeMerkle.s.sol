...
/**
 * @title Make Merkle Tree
 * @author Aashim
 * @notice It was originally implemented by @dmfxyz github
 * @dev This is the copy of murky generate Merkle Tree.  repo: https://github.com/dmfxyz/murky/blob/main/script/Merkle.s.sol
 */
